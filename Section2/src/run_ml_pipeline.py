...
if __name__ == "__main__":
    ...
    # <YOUR CODE GOES HERE>
    split['train'], split['test'] = train_test_split(keys, test_size=0.4, random_state=42)
    split['train'], split['val'] = train_test_split(split['train'], test_size=0.5, random_state=42)
